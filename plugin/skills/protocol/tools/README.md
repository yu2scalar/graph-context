...
> Status: v3.3.0-dev.1 (2026-09-25, D33: backlog, set-next, set-issue, close, PLANNED; v3.2.0 2026-09-24, D26; revised after peer review: seconds precision, --lang default from config, D24b scoping, scan counts, log, footer, write helpers)
